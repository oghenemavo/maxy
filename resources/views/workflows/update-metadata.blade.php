<div class="m-login__signup">
	...
	<form class="m-login__form m-form" action="#" method="post">
		...
		<div class="form-group">
            ...
            {!! Form::select('fields[]', $fields, @$step_fields, ['class' =>'form-control select2', 'multiple']) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        @if(!$isEdit)
            var url = "{{ route('update-step-metadata', [ $step_id ] ) }}";
        @else
            var url = "{{ route('update-step-metadata', [ $step_id, @$trigger->id ] ) }}";
        @endif
