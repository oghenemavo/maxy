<?php
    ...
    class CreateWorkflowStepCombinedTriggers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('workflow_step_combined_triggers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('workflow_step_combined_triggers');
    }
}
